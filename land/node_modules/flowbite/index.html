...
<html lang="pt" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://govhub.github.io/govhub/land/node_modules/flowbite/">
...
<nav class="md-nav md-nav--secondary" aria-label="Índice">
  ...
  <a href="#getting-started" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Getting started">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#require-via-npm" class="md-nav__link">
    <span class="md-ellipsis">
      Require via NPM
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#include-via-cdn" class="md-nav__link">
    <span class="md-ellipsis">
      Include via CDN
    </span>
  </a>
  ...
  <a href="#copyright-and-license" class="md-nav__link">
    ...
    <a href="https://github.com/GovHub-br/govhub/edit/master/docs/land/node_modules/flowbite/README.md" title="Editar esta página" class="md-content__button md-icon">
    ...
    <a href="https://github.com/GovHub-br/govhub/raw/master/docs/land/node_modules/flowbite/README.md" title="Exibir fonte desta página" class="md-content__button md-icon">
...
<p>For full documentation, visit <a href="https://flowbite.com/">flowbite.com</a>.</p>
...
<h3 id="require-via-npm">Require via NPM<a class="headerlink" href="#require-via-npm" title="Permanent link">&para;</a></h3>
...
<div class="language-bash highlight"><pre><span></span><code><span id="__span-0-1"><a id="__codelineno-0-1" name="__codelineno-0-1" href="#__codelineno-0-1"></a>npm<span class="w"> </span>i<span class="w"> </span>flowbite
</span></code></pre></div>
<ol>
<li>Require Flowbite as a plugin inside the <code>tailwind.config.js</code> file:</li>
</ol>
<div class="language-javascript highlight"><pre><span></span><code><span id="__span-1-1"><a id="__codelineno-1-1" name="__codelineno-1-1" href="#__codelineno-1-1"></a><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span>
</span><span id="__span-1-2"><a id="__codelineno-1-2" name="__codelineno-1-2" href="#__codelineno-1-2"></a>
</span><span id="__span-1-3"><a id="__codelineno-1-3" name="__codelineno-1-3" href="#__codelineno-1-3"></a><span class="w">    </span><span class="nx">plugins</span><span class="o">:</span><span class="w"> </span><span class="p">[</span>
</span><span id="__span-1-4"><a id="__codelineno-1-4" name="__codelineno-1-4" href="#__codelineno-1-4"></a><span class="w">        </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;flowbite/plugin&#39;</span><span class="p">)</span>
...
<ol>
<li>Include the main JavaScript file to make interactive elements work:</li>
</ol>
<div class="language-html highlight"><pre><span></span><code><span id="__span-2-1"><a id="__codelineno-2-1" name="__codelineno-2-1" href="#__codelineno-2-1"></a><span class="p">&lt;</span><span class="nt">script</span> <span class="na">src</span><span class="o">=</span><span class="s">&quot;../path/to/flowbite/dist/flowbite.js&quot;</span><span class="p">&gt;&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
</span></code></pre></div>
<p>If you use Webpack or other bundlers you can also import it like this:</p>
<div class="language-javascript highlight"><pre><span></span><code><span id="__span-3-1"><a id="__codelineno-3-1" name="__codelineno-3-1" href="#__codelineno-3-1"></a><span class="k">import</span><span class="w"> </span><span class="s1">&#39;flowbite&#39;</span><span class="p">;</span>
</span></code></pre></div>
<h3 id="include-via-cdn">Include via CDN<a class="headerlink" href="#include-via-cdn" title="Permanent link">&para;</a></h3>
...
<p>Require the following minified stylesheet inside the <code>head</code> tag:</p>
<div class="language-html highlight"><pre><span></span><code><span id="__span-4-1"><a id="__codelineno-4-1" name="__codelineno-4-1" href="#__codelineno-4-1"></a><span class="p">&lt;</span><span class="nt">link</span> <span class="na">rel</span><span class="o">=</span><span class="s">&quot;stylesheet&quot;</span> <span class="na">href</span><span class="o">=</span><span class="s">&quot;https://unpkg.com/flowbite@latest/dist/flowbite.min.css&quot;</span> <span class="p">/&gt;</span>
</span></code></pre></div>
<p>And include the following javascript file before the end of the <code>body</code> element:</p>
<div class="language-html highlight"><pre><span></span><code><span id="__span-5-1"><a id="__codelineno-5-1" name="__codelineno-5-1" href="#__codelineno-5-1"></a><span class="p">&lt;</span><span class="nt">script</span> <span class="na">src</span><span class="o">=</span><span class="s">&quot;https://unpkg.com/flowbite@latest/dist/flowbite.js&quot;</span><span class="p">&gt;&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
</span></code></pre></div>
<h2 id="community">Community<a class="headerlink" href="#community" title="Permanent link">&para;</a></h2>
<p>If you need help or just want to discuss about the library join the community on Github:</p>
<p>⌨️ <a href="https://github.com/themesberg/flowbite/discussions">Discuss about Flowbite on GitHub</a></p>
<p>For casual chatting with others using the library:</p>
<p>💬 <a href="https://discord.gg/4eeurUVvTy">Join the Flowbite Discord Server</a></p>
<h2 id="figma">Figma<a class="headerlink" href="#figma" title="Permanent link">&para;</a></h2>
<p>If you need the Figma files for the components you can check out our website for more information:</p>
<p>🎨 <a href="https://flowbite.com/figma/">Get access to the Figma design files</a></p>
<h2 id="copyright-and-license">Copyright and license<a class="headerlink" href="#copyright-and-license" title="Permanent link">&para;</a></h2>
<p>The Flowbite name and logos are trademarks of Crafty Dwarf Inc. </p>
<p>📝 <a href="https://flowbite.com/docs/getting-started/license/">Read about the licensing terms</a></p>
